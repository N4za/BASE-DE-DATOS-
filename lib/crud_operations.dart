...
class DBHelper {
  ...
  _onCreate(Database db, int version) async {
    await db.execute(
        "CREATE TABLE $TABLE ($Id INTEGER PRIMARY KEY AUTOINCREMENT, $NAME TEXT, $APPP TEXT, $APPM TEXT, $TELEF TEXT, $CORREO TEXT, $MATRICULA TEXT)");
  }
  ...
  Future<List<Student>> getStudents() async {
    ...
    List<Map> maps = await dbClient
        .query(TABLE, columns: [Id, NAME, APPP, APPM, TELEF, CORREO, MATRICULA]);
